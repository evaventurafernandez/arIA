...
tags:
  ...
  - dbscan
  - umbrales
contexto: "Decisión de diseño del módulo de chat LLM del visor MeteoVisor (worktree feature/chat-llm). Fija los valores por defecto de los parámetros sensibles de las tools de análisis y la ventana temporal de cobertura inyectada en el prompt."
fuente_existe: false
...
- `firesNearPopulation.distance_m = 5000` (5 km). Origen: documento de partida del TFG, donde la proximidad operativa "focos junto a núcleos" se define con ese radio.
