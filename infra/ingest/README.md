# Ingesta y publicación de datos

Esta guía describe los flujos vigentes de ingesta y publicación en PostgreSQL/PostGIS de las capas con histórico persistido (avisos AEMET, focos NASA FIRMS y áreas quemadas Copernicus).
